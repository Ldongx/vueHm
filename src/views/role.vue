<template>
    <el-card>
        ...
        <el-col>
            ...
            <el-button type="primary" class="role_button">添加角色</el-button>
            </el-col>
        </el-col>
    <el-table
    :data="list"
      ...
      <template slot-scope="scope">
        <el-row class="level1" v-for="(item1,index) in scope.row.children" :key="index">
            ...
            <el-col :span="20">
                ...
                <el-col :span="4">
                <el-tag closable type="success" @close="deleRight(scope.row,item2.id)">{{item2.authName}}</el-tag>
                <i class="el-icon-caret-right"></i>          
                </el-col>
                <el-col :span="20">
                <el-tag @close="deleRight(scope.row,item3.id)" closable type="info" v-for="(item3,index) in item2.children" :key="index">{{item3.authName}}</el-tag>    
                </el-col>
                </el-row>
            </el-col>
        </el-row>
